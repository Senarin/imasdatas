  ...
  r.onreadystatechange = function(){
   if(r.readyState == 4){
    if(r.status == 200){
     ...
     var $eLast = new Number($("#theater_elist_j td[data-event-id][data-event-id]").last()[0].getAttribute("data-event-id"));

     if($eLast < 0){$("#theater_elist_j td[data-event-id][data-event-id!='-1']").last()[0].setAttribute("data-event-id",eid);}
