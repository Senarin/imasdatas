  ...
  r.onreadystatechange = function(){
   if(r.readyState == 4){
    if(r.status == 200){
     ...
     if($("#theater_elist_j td[data-event-id='"+eid+"'][data-event-id!='-1']").length != 0){var $eTitle = document.createTextNode($("#theater_elist_j td[data-event-id='"+eid+"'][data-event-id!='-1']").last().html().replace("<br>","\n").replace("&amp;","&"));}
