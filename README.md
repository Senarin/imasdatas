...
- 이 저장소에 게시된 일부 저작물(```/assets``` 경로에 있는 파일들 및 ```/css```, ```/js``` 경로 아래에 있는 일부 파일)에 대한 권리는 [반다이 남코 엔터테인먼트](http://www.bandainamcoent.co.kr/)를 비롯한 각 당사자에게 있습니다. 자세한 사항은 [이 페이지](https://r1.senarin.kr/license_disclaimer.htm)를 참고 바랍니다.
